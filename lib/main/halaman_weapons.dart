...
import '../data_api/daftar_weapons.dart';
import '../fitur/clock.dart';
import '../models_hive/fav.dart';
import 'detail_weapons.dart';

class HalamanWeapons extends StatefulWidget {
  const HalamanWeapons({Key? key}) : super(key: key);

  @override
  _HalamanWeaponsState createState() => _HalamanWeaponsState();
}

class _HalamanWeaponsState extends State<HalamanWeapons> {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                    child: Text(
                      'Provides information about Valorant. Find your favorite weapon and find out the information',
                      style: TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.normal,
                          color: Colors.white),
  ...
  Widget _buildDaftarWeaponsBody() {
    return FutureBuilder(
      future: ApiDataSourceWeapons.instance.loadWeapons(),
  ...
  Widget _buildSuccessSection(DaftarWeapons daftarWeapons) {
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        return _buildItemWeapons(context, daftarWeapons.data![index]);
      },
    );
  }
  ...
  Widget _buildItemWeapons(BuildContext context, Data weaponsData) {
    return InkWell(
